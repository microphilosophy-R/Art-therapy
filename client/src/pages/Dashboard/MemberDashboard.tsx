...
import { UnifiedProfileTab } from './tabs/UnifiedProfileTab';
...
export const MemberDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState<'certificates' | 'profile'>('certificates');
  ...
  return (
    <div className="bg-stone-50 min-h-screen">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {activeTab === 'profile' && <UnifiedProfileTab />}
      </div>
    </div>
  );
};
